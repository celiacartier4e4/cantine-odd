...
# Le style ci-dessous crée le cadre (border) et l'effet d'ombre (box-shadow)
st.markdown('<div style="border: 1px solid #E0E0E0; padding: 15px; border-radius: 10px; box-shadow: 0px 4px 12px rgba(0,0,0,0.1); margin-bottom: 25px;">', unsafe_allow_html=True)
