...
# --- STYLE CSS SÉCURISÉ (LIGNES VOLONTAIREMENT COURTES POUR ÉVITER LES COUPURES) ---
css_lines = [
    "<style>",
    ".block-container { padding-top: 1rem !important; padding-bottom: 0rem !important; }",
    ".block-container { padding-left: 2rem !important; padding-right: 2rem !important; }",
    ".stApp { background: linear-gradient(rgba(255, 255, 255, 0.1), rgba(15, 23, 42, 0.8)), ",
    ...
    "font-family: 'Segoe UI', Roboto, sans-serif; text-shadow: 1px 1px 4px rgba(0,0,0,0.9); }",
    "div[data-testid='stBlock'] { gap: 0.4rem !important; }",
    ".card-base { padding: 12px 16px; border-radius: 12px; margin-bottom: 12px; ",
    "box-shadow: 0 6px 14px rgba(0, 0, 0, 0.4); border-left: 6px solid rgba(0,0,0,0.3); }",
    ...
    ".kpi-card { border-radius: 8px; padding: 10px; text-align: center; ",
    "box-shadow: 0 4px 10px rgba(0,0,0,0.4); color: white !important; }",
    ...
    ".institution-box { background: rgba(15, 23, 42, 0.85); border: 2px solid #38BDF8; ",
    "padding: 12px; border-radius: 10px; margin-bottom: 10px; }",
    ".institution-box * { color: #38BDF8 !important; }",
    "div [data-testid='stProgressBar'] > div > div { ",
    "background-image: linear-gradient(to right, #FF3333, #FFCC00, #00FF66) !important; }",
    "div[data-testid='stWidgetLabel'] p { color: #FFFFFF !important; font-weight: bold !important; }",
    ".card-gold div[data-testid='stWidgetLabel'] p { color: #000000 !important; }",
    ".card-cyan div[data-testid='stWidgetLabel'] p { color: #000000 !important; }",
    "</style>"
]
