...
# --- CATEGORIE 1 : Déchets Alimentaires (Rouge/Rose Pastel) ---
st.markdown('<div style="background-color: #FFE5E5; padding: 15px; border-radius: 10px; border-left: 5px solid #FF9999; margin-bottom: 20px;">', unsafe_index=True)
...
# --- CATEGORIE 2 : Poubelle à Pain (Orange/Jaune Pastel) ---
st.markdown('<div style="background-color: #FFF2CC; padding: 15px; border-radius: 10px; border-left: 5px solid #F1C232; margin-bottom: 20px;">', unsafe_index=True)
...
st.markdown('<div style="background-color: #E2EFDA; padding: 15px; border-radius: 10px; border-left: 5px solid #A9D08E; margin-bottom: 20px;">', unsafe_index=True)
...
st.markdown('<div style="background-color: #DDEBF7; padding: 15px; border-radius: 10px; border-left: 5px solid #9BC2E6; margin-bottom: 20px;">', unsafe_index=True)
...
st.markdown('<div style="background-color: #E1D5E7; padding: 15px; border-radius: 10px; border-left: 5px solid #B4A7D6; margin-bottom: 20px;">', unsafe_index=True)
