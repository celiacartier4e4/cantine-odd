...
# Injection CSS du style global et de l'effet Glossy
css_glossy = f"""
<style>
[data-testid='stApp'] {{
...
# ==========================================
# On donne plus de place aux bilans à gauche (ratio 3 pour 1)
col_gauche, col_droite = st.columns([3, 1])

# --- COLONNE DE DROITE : LE GRAND ENCADRÉ GLOSSY DE SAISIE ---
with col_droite:
...
with col_gauche:
    ...
    st.bar_chart(df_bilan, horizontal=True, height=150)
    
    st.write(" ")
    st.write(" ")
    
    # Section des calculs chiffrés
    st.write("### 📊 Calculs d'Impact Environnemental")
    bilan_co2 = tot_masse * 2.0
    equiv_km = bilan_co2 / 0.12
    
    # Affichage aéré des indicateurs principaux
